...
MERCURY600="#1C2E36";MERCURY500="#233A44";URANUS300="#A3BABD";URANUS0="#EDF2F2";SUN_ORANGE="#F46F29"
...
<style>
  ...
  section[data-testid="stSidebar"] input,section[data-testid="stSidebar"] textarea{{background-color:#16242B;color:#FFF}}
  section[data-testid="stSidebar"] div[data-baseweb="select"]>div{{background-color:#16242B;color:#FFF;border-color:#3A4F59}}
  ...
  section[data-testid="stSidebar"] [data-testid="stTooltipHoverTarget"] svg *{{
      color:{URANUS300}!important;fill:{URANUS300}!important;stroke:{URANUS300}!important;opacity:1!important}}
...
function showError(msg){{
  var lo=document.getElementById("loading_overlay"),eo=document.getElementById("error_overlay"),
      ed=document.getElementById("error_detail");
...
def render_potree_viewer(bundle, point_budget):
    ...
    html=_potree_html(f"{r2p}/{pk}",f"{r2p}/potree-assets",
...
_LIGHTING={"@@type":"LightingEffect",
    ...
    "_lights":[{"@@type":"DirectionalLight","color":[255,255,255],"intensity":1.0,"direction":[-2,-4,-1]}]}
...
def render_point_cloud(bundle,visible_layers,point_size):
    ...
    with st.spinner("Preparing point cloud…"):
        ...
        deck=pdk.Deck(layers=[layer],initial_view_state=pdk.ViewState(
              ...
              map_provider=None,map_style="",tooltip={"text":"Z: {z} m"},effects=[_LIGHTING])
